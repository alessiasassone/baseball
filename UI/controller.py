...
class Controller:
    ...
    # Questo metodo viene chiamato quando qualcuno ha selezionato un anno, deve recuperare tutti i team che hanno giocato quell'anno,
    # e stamparli nel textfield e anche riempire il dropdown sotto
    ...
    # Mette in choice l'evento selezionato, cioè la squadra
